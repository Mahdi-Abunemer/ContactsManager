...
namespace CRUDTests
{
    public class PersonsServiceTest
    {
        ...
        public PersonsServiceTest(ITestOutputHelper testOutputHelper)
        {
            ...
            var getterLoggerMock = new Mock<ILogger<PersonsGetterService>>();
            var adderLoggerMock = new Mock<ILogger<PersonsAdderService>>();
            var updaterLoggerMock = new Mock<ILogger<PersonsUpdaterService>>();
            var deleterLoggerMock = new Mock<ILogger<PersonsDeleterService>>();
            var sorterLoggerMock = new Mock<ILogger<PersonsSorterService>>();

            _personsGetterService = new PersonsGetterService(_personsRepository, getterLoggerMock.Object, diagnosticContextMock.Object);

            _personsAdderService = new PersonsAdderService(_personsRepository, adderLoggerMock.Object, diagnosticContextMock.Object);

            _personsDeleterService = new PersonsDeleterService(_personsRepository, deleterLoggerMock.Object, diagnosticContextMock.Object);

            _personsSorterService = new PersonsSorterService(_personsRepository, sorterLoggerMock.Object, diagnosticContextMock.Object);

            _personsUpdaterService = new PersonsUpdaterService(_personsRepository, updaterLoggerMock.Object, diagnosticContextMock.Object);
        ...
        public async Task GetSortedPersons_ToBeSuccessful()
        {
            ...
            //Act
            List<PersonResponse> persons_list_from_sort = await _personsSorterService.GetSortedPersons(allPersons, nameof(Person.PersonName), SortOrderOptiions.DESC);
